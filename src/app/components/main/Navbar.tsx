    ...
    <nav className="w-full h-[65px] fixed top-0 shadow-lg shadow-[#2A0E61]/50 bg-[#03001417] backdrop-blur-md z-50 px-10">
        <div className="w-full h-full flex flex-row items-center justify-between m-auto px-[10px]">
            ...
            <div className="flex flex-row gap-9">
                {/* <!-- LinkedIn --> */}
                <Link href="https://www.linkedin.com/in/albt03/" target='_blank'>
                    <svg
                ...
                {/* <!-- Github --> */}
                <Link href="https://github.com/Al-phob" target="_blank">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-7 w-7"
                        fill="currentColor"
                ...
                {/* <!-- Discord --> */}
                <Link href="https://discordapp.com/users/758334590930255902" target="_blank">
                    <svg
                        className="h-7 w-7"
                        fill="currentColor"
                        style={{ color: "#7289da" }}
